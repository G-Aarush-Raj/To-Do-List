#Function to add the task for to do list by providing the priority and due date
def add_task(tasks):
...
#Function to remove the task which is completed or not required
...
#Function to show the status of the task completed or not
def mark_task_completed(tasks):
    ...
    for i in tasks:
        if i["name"] == task_name:
            ...
            return
    print("Task not found.")
#Function to display the existing tasks and to view their completion status
...
tasks = []
#Organized menu for a clear user interface
while True:
    print("\n------- TO-DO LIST MENU -------")
    print("1. Add Task")
    print("2. Remove Task")
